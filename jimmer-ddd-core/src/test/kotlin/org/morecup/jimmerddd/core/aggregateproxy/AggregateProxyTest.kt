...
import org.morecup.jimmerddd.core.preanalysis.analysisFunctionFetcher
...
class AggregateProxyTest {
    ...
    fun testFetcher(){
        val order: Order =
            sql.findById(analysisFunctionFetcher(OrderImpl::renameUserDetailMsg, Order::class), testOrderId)!!
